				...
				<table width="100%">
					<tr>
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0"
								...
								<tr>
									<td colspan="2">
										...
										<font class="word2"> 编辑相册 - ${album.name } </font>
										<br />
										<br />
									</td>
								</tr>
								...
								<tr>
									<td valign="top" colspan="2" align="center">
										<form action="/xiaonei/album/addPhoto.action" method="post"
											...
											<table width="80%" cellpadding="5" cellspacing="5">
												<tr>
													...
													<td>
														<input type="file" name="photo" class="wby" size="40" />
													</td>
												</tr>
												<tr>
													<td>
						...
						<td valign="top" align="center">
							<img src="/xiaonei/images/front/photoright.jpg" />
						</td>
					</tr>
				</table>
			</div>
