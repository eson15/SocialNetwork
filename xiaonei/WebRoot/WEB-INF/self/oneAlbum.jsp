						...
						<td width="80%" valign="top">
							<div class="divTbl">
								<table width="100%" border="0" 
									...
									<tr>
										<td colspan="2">
											<table width="100%" border="0" >
												...
												<tr>
													<td>
														<a href="/xiaonei/album/albumUI.action" class="xh">返回我的相册</a>
													</td>
												</tr>
											</table>
										</td>
									...
									<tr>
										<td>
											<font class="word4">第1 -1 张 / 共${fn:length(album.photos) }张 |</font>
											<a href="#" class="xh">设置相册</a>
											|
											<a href="#" class="xh">上传照片</a>
									...
									<tr>
										<td valign="top" colspan="2"
											...
											<table width="100%" border="0">
												<tr>
													<c:forEach var="photo" items="${album.photos}" varStatus="vs">
													 <td width="20%" align="center">
														<a href="/xiaonei/album.do?flag=onePhotoUI&pid=xx&oid=xx&aid=xx&pageNo=1"
															style="border: 1px #D8DFEA solid;"
															onmouseover="chgImg(this)" onmouseout="chgImg2(this)"
															id="a x"> <img src="/xiaonei/images/${user.id }/album/${photo.album.virname }/${photo.photo}"
																width="100px" height="100px" alt="xxxx"
									...
									<tr>
										<td colspan="2">
											<font class="word4">${album.descript }</font>
										</td>
									</tr>
									<tr>
										<td>
