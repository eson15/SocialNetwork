...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<link rel="stylesheet" href="/xiaonei/css/css/homePage.css" type="text/css"></link>
		<link rel="stylesheet" href="/xiaonei/css/css/common.css" type="text/css"></link>
		<script type="text/javascript" src="/xiaonei/js/common.js"></script>
	...
	<body>
		...
		<div class="homePage">
			<div class="homePage_intro">
				...
				<table>
						...
						<td>
							<c:choose>
								<c:when test="${fn:contains(user.photo, 'default.gif')}">	
									<img src="/xiaonei/images/userhead/default.gif" width="150"
									height="150" />	
								</c:when>
								<c:otherwise>																			
									<img src="/xiaonei/images/${user.id }/head/${user.photo }?abc=<%=Math.random() %>" width="150"
									height="150" />
								</c:otherwise>
							</c:choose>
						</td>
					...
					<tr>
						<td onMouseOver="chgTblusers(this)"
							...
							&nbsp;
							<a href="/xiaonei/profile/uploadphotoUI.action" class="xh" id="editphotoa">更改我的头像</a>
						</td>
					</tr>
					<tr>
						<td onMouseOver="chgTblusers(this)"
				...
				<div class="allkinds">
					<img src="/xiaonei/images/front/profileleft.jpg" />
				</div>
			</div>
			<!-- 各种信息 -->
			<div class="profile">
				...
				<div class="curInfo">
					...
					<img src="/xiaonei/images/front/star.gif" />
					&nbsp;
				...
				<div class="opers">
					<table align="center" border="0" width="100%" cellspacing="1"
						...
						<tr>
							...
							<td class="feedsp" align="center">
								<a href="/xiaonei/album/albumUI.action" class="feed">相册</a>
							</td>
							<td class="feedsp" align="center">
							...
							<td>
								<a href="album.do?type=oneAlbum&oid=xx&pageNo=1&aid=xx"
									...
									onmouseout="chgImg2(this)" id="a100"> <img
										src="/xiaonei/images/photos/t4.jpg" width="100px" height="75px"
					...
					<table>
						...
						<tr>
							<td style="border-bottom: 1px #D8DFEA solid;">
								<img src="/xiaonei/images/front/blog.gif " />
							</td>
							<td style="border-bottom: 1px #D8DFEA solid;">
						...
						<tr>
							<td rowspan="2" width="8%">
								<a href="profile.do?type=feed&oid=xx"> <img
										src="/xiaonei/images/userhead/u1.gif" width="50px" height="50px" /> </a>
							</td>
							<td>
						...
						<tr>
							<td>
								<a href="profile.do?type=feed&oid=xxx"> <img
										src="/xiaonei/images/userhead/u1.gif" width="50px" height="50px" />
								</a>
							</td>
							<td>
