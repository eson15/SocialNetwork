...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<link rel="stylesheet" href="/xiaonei/css/css/home.css" type="text/css"></link>
			...
			<div class="types">
				<div class="types_tab">
					<table>
						...
						<tr>
							<td>
								<img src="/xiaonei/images/front/group.gif" />
							</td>
							<td>
						...
						<tr>
							<td>
								<img src="/xiaonei/images/front/share.gif" />
							</td>
							<td>
						...
						<tr>
							<td>
								<img src="/xiaonei/images/front/gift.gif" />
							</td>
							<td>
						...
						<tr>
							<td>
								<img src="/xiaonei/images/front/toupiao.gif" />
							</td>
							<td>
				...
				<div class="home_ad">
					<img src="/xiaonei/images/front/homeleft.jpg" />
				</div>
			</div>
			<div class="content">
				<div class="profile">
					<table>
						<tr>
							<td rowspan="3" width="193px">
								...
								<c:when test="${fn:contains(user.photo, 'default.gif')}">	
									<img src="/xiaonei/images/userhead/default.gif?abc=<%=Math.random() %>" width="150"
									height="150" />	
								</c:when>
								<c:otherwise>																			
						...
						<tr>
							<td width="83">
								<img src="/xiaonei/images/front/status.gif" />
				...
				<div class="mes_response">
					<table>
						...
						<tr>
							<td>
								<img src="/xiaonei/images/front/wall_post.gif" />
				...
				<div class="popular">
					<table>
						...
						<tr>
							<td>
								<a><img src="/xiaonei/images/userhead/u1.gif" width="55px"
										height="55px" /> </a>
						...
						<tr>
							<td>
								<a href="profile.do?type=feed&oid=xx"> <img
										src="/xiaonei/images/userhead/u14.gif" width="55px" height="55px" /> </a>
								<!-- 如果该人在线，则显示 -->
								<img src="/xiaonei/images/front/online.gif" />
								<a href="profile.do?type=feed&oid=xx" class="xh">三少爷</a>
